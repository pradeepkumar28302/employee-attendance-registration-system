		...
		<div class = "container-fluid admin" >
			...
			<div class = "well col-lg-12">
				<table id="table" class="table table-bordered table-striped">
					...
					<tbody>
					<?php
						$attendance_qry = $conn->query("SELECT a.*,concat(e.name,'') as name, e.employee_no FROM `attendance` a inner join employee e on a.employee_id = e.id ") or die(mysqli_error());
